  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col selection:bg-primary/20">
      ...
      <section className="relative pt-20 pb-24 overflow-hidden flex flex-col items-center justify-center text-center px-4">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-1.5 text-xs font-black bg-amber-500/10 text-amber-500 rounded-full border border-primary/20 mb-6 z-10">
            <LuRocket
          ...
          <h1 className="text-4xl md:text-6xl font-black tracking-tighter mb-6 z-10 max-w-4xl leading-tight">
            Discovery Redefined.
            <br />
